...
```java
var anovaResult = Stats.anova.oneWay(groups);
...
var result = Opts.ip(c, A, b);  // 整数规划求解
...
for (var x0 : starts) {
    var result = Opts.gradientDescent(f, Linalg.vector(x0), lr=0.01, maxIter=1000);
