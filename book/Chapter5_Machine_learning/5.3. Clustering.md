...
// 构造：先设随机种子，再设簇数参数
KMeansPlusPlus km = new KMeansPlusPlus(42L);  // 固定种子保证可复现性
km.setParameters(Map.of("k", 2));            // 设置簇数
km.fit(data);
...
// 肘部法则
for (int k = 2; k <= 6; k++) {
    KMeansPlusPlus km = new KMeansPlusPlus(42L);
    km.setParameters(Map.of("k", k));
    km.fit(data);
