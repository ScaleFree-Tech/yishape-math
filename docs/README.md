...
4. **按主题深入**（顺序可调整）/ **Topic deep dives** (order flexible)：
   ...
   - 自动微分 / Autodiff：[Autodiff-Reference.md](Autodiff-Reference.md) + [examples/Autodiff-Examples.md](examples/Autodiff-Examples.md)（`Autodiff`）
   - 多目标线性规划 / MCLP：[MCLP/README.md](MCLP/README.md) + [examples/MCLP-Examples.md](examples/MCLP-Examples.md)（`Opts.mclp`）
   - 多目标二次规划 / MCQP：[MCQP/README.md](MCQP/README.md)（`Opts.mcqp`）
   ...
   - 距离度量学习 / DML：[DML/README.md](DML/README.md) + [examples/DML-Examples.md](examples/DML-Examples.md)（`ML.dml`，含自主研发算法 DDML）
...
| [DML/README.md](DML/README.md) | 距离度量学习（包含自主研发 DDML 算法）/ Distance metric learning (includes proprietary DDML) |
| [Optimization-Algorithms.md](Optimization-Algorithms.md) | 优化与线性规划 / Optimization and linear programming |
| [Autodiff-Reference.md](Autodiff-Reference.md) | 自动微分 API 参考 / Automatic differentiation API reference |
| [MCLP/README.md](MCLP/README.md) | 多目标线性规划 / Multi-criteria linear programming |
| [MCQP/README.md](MCQP/README.md) | 多目标二次规划 / Multi-criteria quadratic programming |
...
| [HPC-Performance.md](HPC-Performance.md) | HPC / SIMD / SISD 性能对比与后端选择指南 / HPC/SIMD/SISD performance comparison and backend selection guide |
