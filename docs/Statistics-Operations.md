...
// 将 double[][] 转为 List<IVector<Double>> / Convert double[][] to List<IVector<Double>>
...
2. **数值精度** / **Numerical Precision**: 使用double类型，注意浮点精度限制 / Uses double type, note floating point precision limitations
