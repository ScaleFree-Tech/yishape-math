...
public class VectorBasicExample {
    public static void main(String[] args) {
        ...
        IVector<Double> scalarMul = v1.multiplyByScalar(2.0);
...
public class VectorChainingExample {
    public static void main(String[] args) {
        ...
        IVector<Double> result = Linalg.range(100)                    // 创建0-99的向量
            .slice(10, 90)                                              // 取10-89
            .multiplyByScalar(0.1)                                        // 乘以0.1
            .addScalar(5.0)                                             // 加5
            .square()                                                    // 平方
            .sqrt()                                                     // 开方
            .multiplyByScalar(2.0);                                       // 乘以2
        ...
        IVector<Double> sensorData = Linalg.rand(1000).multiplyByScalar(100.0).addScalar(50.0);
...
public class SignalProcessingExample {
    public static void main(String[] args) {
        ...
        IVector<Double> time = Linalg.range(signalLength).multiplyByScalar(0.01); // 时间轴 / Time axis
        
        // 生成复合信号：正弦波 + 噪声 / Generate composite signal: sine wave + noise
        IVector<Double> signal = time.multiplyByScalar(2 * Math.PI * 10)  // 10Hz正弦波 / 10Hz sine wave
            .sin()
            .add(Linalg.rand(signalLength).multiplyByScalar(0.1)); // 添加噪声 / Add noise
