...
└── com/yishape/lab/
    ...
    │   │   │   ├── RereFA.java                  # 因子分析降维 / Factor Analysis Dimensionality Reduction
    │   │   │   ├── RereNMF.java                 # 非负矩阵分解降维 / NMF Dimensionality Reduction
    │   │   │   └── RereKernelPCA.java           # 核PCA降维 / Kernel PCA Dimensionality Reduction
