 ...
 * <p>
 * 扩展IAudioFilter接口，专门用于音乐相关的滤波处理，
 * 包括音乐频带滤波、和声滤波、音符滤波等。
 * </p>
 * <p>
 * Extends IAudioFilter interface specifically for music-related filtering processing,
 ...
 * @since 1.0
 */
public interface IMusicFilter extends IAudioFilter {
     ...
     * @throws AudioProcessingException 当滤波过程中发生错误时抛出 / Thrown when error occurs during filtering
     */
    AudioData filterByScale(AudioData audioData, int rootNote, MusicTheory.ScaleType scaleType) throws AudioProcessingException;
     ...
     * @throws AudioProcessingException 当滤波过程中发生错误时抛出 / Thrown when error occurs during filtering
     */
    AudioData filterByChord(AudioData audioData, MusicTheory.Chord chord, boolean enhance) throws AudioProcessingException;
     ...
     * @throws AudioProcessingException 当滤波过程中发生错误时抛出 / Thrown when error occurs during filtering
     */
    AudioData spectralSubtraction(AudioData audioData, MusicTheory.Key referenceKey, double aggressiveness) throws AudioProcessingException;
