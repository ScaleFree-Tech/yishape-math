...
public class WaveletUtilities {
     ...
     */
    public static IVector<Double> analyzeWaveletEnergy(WaveletAnalysis.WaveletCoefficients coeffs) {
     ...
     */
    public static IVector<Double> analyzeWaveletEntropy(WaveletAnalysis.WaveletCoefficients coeffs) {
        int totalLevels = coeffs.levels + 1;
     ...
     * 计算阈值 / Calculate Threshold
     */
    private static double calculateThreshold(WaveletAnalysis.WaveletCoefficients coeffs, ThresholdMethod method) {
        switch (method) {
            case RIGRSURE:
     ...
     */
    private static double calculateRigrsureThreshold(WaveletAnalysis.WaveletCoefficients coeffs) {
     ...
     */
    private static double calculateSureThreshold(WaveletAnalysis.WaveletCoefficients coeffs) {
        // 收集所有细节系数 / Collect all detail coefficients
        java.util.List<Double> allDetails = new java.util.ArrayList<>();
        for (int i = 0; i < coeffs.levels; i++) {
            for (int j = 0; j < coeffs.details[i].length(); j++) {
     ...
     */
    private static double calculateHeursureThreshold(WaveletAnalysis.WaveletCoefficients coeffs) {
     ...
     */
    private static double calculateMinimaxThreshold(WaveletAnalysis.WaveletCoefficients coeffs) {
        // 收集所有细节系数 / Collect all detail coefficients
        java.util.List<Double> allDetails = new java.util.ArrayList<>();
        for (int i = 0; i < coeffs.levels; i++) {
            for (int j = 0; j < coeffs.details[i].length(); j++) {
     ...
     * 计算压缩阈值 / Calculate Compression Threshold
     */
    private static double calculateCompressionThreshold(WaveletAnalysis.WaveletCoefficients coeffs, double compressionRatio) {
     ...
     */
    private static java.util.List<Double> extractEnergyFeatures(WaveletAnalysis.WaveletCoefficients coeffs) {
        java.util.List<Double> features = new java.util.ArrayList<>();
     ...
     */
    private static java.util.List<Double> extractEntropyFeatures(WaveletAnalysis.WaveletCoefficients coeffs) {
        java.util.List<Double> features = new java.util.ArrayList<>();
