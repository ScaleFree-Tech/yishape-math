...
public class RereFloatVector implements IFloatVector,Serializable {
     ...
     */
    private static final Queue<RereFloatVector> VECTOR_POOL = new ConcurrentLinkedQueue<>();
     ...
     */
    public static RereFloatVector borrowVector(int length) {
        RereFloatVector vector = VECTOR_POOL.poll();
        if (vector == null) {
            return new RereFloatVector(length);
        }
     ...
     */
    private RereFloatVector reset(int length) {
     ...
     */
    @Override
    public IVector<Float> sub(IVector<Float> vec) {
        var res = this.computer.binaryOperate(data, vec.toFloatArray(), IFloatVectorComputer.BinaryOperation.SUBTRACT);
     ...
     */
    @Override
    public IVector<Float> add(IVector<Float> vec) {
        var res = this.computer.binaryOperate(data, vec.toFloatArray(), IFloatVectorComputer.BinaryOperation.ADD);
        var vv = IFloatVector.of(res);  // 创建结果向量对象
        return vv;
    }
     ...
     */
    @Override
    public Float innerProduct(IVector<Float> vec) {
        float res = this.computer.binaryReduceOperate(data, vec.toFloatArray(), IFloatVectorComputer.BinaryReduceOperation.DOT);
        return res;
    }

    @Override
    public Float dot(IVector<Float> vec) {
    ...
    public Float norm2() {
        ...
        return (float)Math.sqrt(computer.reduceOperate(squared, IFloatVectorComputer.ReduceOperation.SUM));
    }
    ...
    public Float norm1() {
        ...
        return computer.reduceOperate(squared, IFloatVectorComputer.ReduceOperation.SUM);
    }
     ...
     */
    @Override
    public IVector<Float> divideByScalar(Float p) {
        var res = this.computer.binaryOperate(data, p, IFloatVectorComputer.BinaryOperation.DIVIDE);
     ...
     */
    @Override
    public IVector<Float> multiply(IVector<Float> vec1) {
        var res = this.computer.binaryOperate(data, vec1.toFloatArray(), IFloatVectorComputer.BinaryOperation.MULTIPLY);
        return IFloatVector.of(res);
    }
     ...
     */
    @Override
    public IVector<Float> mmul(IMatrix<Float> matrix) {
        if (matrix == null) {
     ...
     */
    @Override
    public IVector<Float> subScalar(Float p) {
        var res = this.computer.binaryOperate(data, p, IFloatVectorComputer.BinaryOperation.SUBTRACT);
        return IFloatVector.of(res);
    }
     ...
     */
    @Override
    public IVector<Float> addScalar(Float p) {
        var res = this.computer.binaryOperate(data, p, IFloatVectorComputer.BinaryOperation.ADD);
        return IFloatVector.of(res);
    }
     ...
     */
    @Override
    public IVector<Float> multiplyScalar(Float p) {
        var res = this.computer.binaryOperate(data, p, IFloatVectorComputer.BinaryOperation.MULTIPLY);
        return IFloatVector.of(res);
    }
    ...
    public Float var(int ddof) {
        return this.subScalar(this.mean()).pow(2f).sum() / (float) (this.length() - ddof);
    }
    ...
    public Float skewness() {
        ...
        var diff = this.computer.binaryOperate(data, mean, IFloatVectorComputer.BinaryOperation.SUBTRACT);
     ...
     */
    @Override
    public IVector<Float> slice(int start) {
     ...
     */
    @Override
    public IVector<Float> slice(int start, int end) {
     ...
     */
    @Override
    public IVector<Float> slice(int start, int end, int step) {
        // 处理负数索引
        if (start < 0) {
        ...
        if (start >= end) {
            return IFloatVector.of(new float[0]); // 返回空向量
        }

        int[] inds = IFloatVector.range(start, end, step).toIntArray();
     ...
     */
    @Override
    public IVector<Float> slice(String sliceExpression) {
     ...
     */
    @Override
    public IVector<Float> fancyGet(int[] positions) {
     ...
     */
    @Override
    public IVector<Float> booleanGet(boolean[] booleanIndex) {
    ...
    public boolean[] eq(IVector<Float> other) {
        var v = this.computer.logicalCompare(data, other.toFloatArray(), IFloatVectorComputer.LogicalCompare.EQUALS);
        return v;
    }
    ...
    public boolean[] lt(IVector<Float> other) {
        ...
        var v = this.computer.logicalCompare(data, other.toFloatArray(), IFloatVectorComputer.LogicalCompare.LESS_THAN);
    ...
    public boolean[] gt(IVector<Float> other) {
        var v = this.computer.logicalCompare(data, other.toFloatArray(), IFloatVectorComputer.LogicalCompare.GREATER_THAN);
        return v;
    }
    
    @Override
    public boolean[] ge(IVector<Float> other) {
        var v = this.computer.logicalCompare(data, other.toFloatArray(), IFloatVectorComputer.LogicalCompare.GREATER_THAN_OR_EQUALS);
        return v;
    }
    
    @Override
    public boolean[] le(IVector<Float> other) {
        var v = this.computer.logicalCompare(data, other.toFloatArray(), IFloatVectorComputer.LogicalCompare.LESS_THAN_OR_EQUALS);
        return v;
    }
     ...
     */
    @Override
    public IVector<Float> clip(Float lower, Float upper) {
        if (lower > upper) {
     ...
     */
    @Override
    public IVector<Float> pow(Float m) {
        var v1 = this.computer.universalOperate(data, IFloatVectorComputer.UniversalOperation.POW, m);
        return IFloatVector.of(v1);
    }
     ...
     */
    @Override
    public IVector<Float> remainder(Float value) {
     ...
     */
    @Override
    public Float euclideanDistance(IVector<Float> other) {
        var v1 = this.computer.binaryReduceOperate(data, other.toFloatArray(), IFloatVectorComputer.BinaryReduceOperation.L2_NORM);
        return v1;
    }
     ...
     */
    @Override
    public Float manhattanDistance(IVector<Float> other) {
        var v1 = this.computer.binaryReduceOperate(data, other.toFloatArray(), IFloatVectorComputer.BinaryReduceOperation.L1_NORM);
        return v1;
    }
     ...
     */
    @Override
    public Float cosineSimilarity(IVector<Float> other) {
        var dotProduct = this.computer.binaryReduceOperate(data, other.toFloatArray(), IFloatVectorComputer.BinaryReduceOperation.DOT);
    ...
    public boolean[] logicalAnd(IVector<Float> other) {
        var result = this.computer.logicalOperate(data, other.toFloatArray(), IFloatVectorComputer.LogicalOperation.AND);
        return result;
    }

    @Override
    public boolean[] logicalOr(IVector<Float> other) {
        var result = this.computer.logicalOperate(data, other.toFloatArray(), IFloatVectorComputer.LogicalOperation.OR);
        return result;
    }
    ...
    public boolean[] logicalXor(IVector<Float> other) {
        var result = this.computer.logicalOperate(data, other.toFloatArray(), IFloatVectorComputer.LogicalOperation.XOR);
        return result;
    }

    // ========== 累积操作实现 / Cumulative Operations Implementation ==========
    @Override
    public IVector<Float> cumsum() {
        float[] result = new float[this.data.length];
        float sum = 0.0f;
        for (int i = 0; i < this.data.length; i++) {
            sum += this.data[i];
    ...
    @Override
    public IVector<Float> diff() {
        return diff(1);
    }

    @Override
    public IVector<Float> diff(int n) {
    ...
    @Override
    public IVector<Float> where(boolean[] condition, Float x, Float y) {
        if (condition == null) {
    ...
    @Override
    public IVector<Float> where(boolean[] condition, IVector<Float> x, IVector<Float> y) {
        if (condition == null) {
            throw new IllegalArgumentException("条件数组不能为null / Condition array cannot be null");
        }
        if (x == null || y == null) {
    ...
    @Override
    public IVector<Float> repeat(int repeats) {
        if (repeats < 1) {
    ...
    @Override
    public IVector<Float> tile(int reps) {
        if (reps < 1) {
    ...
    public Float norm(Float p) {
        ...
        float[] pd = computer.universalOperate(data, IFloatVectorComputer.UniversalOperation.POW, p);
    ...
    @Override
    public IVector<Float> normalize() {
    ...
    @Override
    public IVector<Float> reciprocal() {
        return this.pow(-1.0f);
    }

    @Override
    public IFloatMatrix outer(IVector<Float> other) {
        var dd = this.computer.outer(data, other.toFloatArray());
     ...
     */
    @Override
    public IMatrix<Float> asColumnVector() {
     ...
     */
    @Override
    public Float dtw(IVector<Float> other) {
        if (other == null) {
        ...
        for (int i = 1; i <= m; i++) {
            for (int j = 1; j <= n; j++) {
                // 计算当前元素对的距离
                float distance = Math.abs(this.data[i - 1] - other.get(j - 1));
     ...
     */
    @Override
    public Float corr(IVector<Float> other) {
        if (other == null) {
            throw new IllegalArgumentException("输入向量不能为null / Input vector cannot be null");
        }
        ...
        // 计算协方差：调用cov方法
        float covariance = this.cov(other);

        // 计算标准差
        float stdX = this.std();
        float stdY = other.std();
     ...
     */
    @Override
    public Float cov(IVector<Float> other) {
        if (other == null) {
            throw new IllegalArgumentException("输入向量不能为null / Input vector cannot be null");
        }
        if (this.data.length != other.length()) {
        ...
        // 计算协方差：使用中心化向量的内积
        IVector<Float> centeredX = this.subScalar(this.mean());
        IVector<Float> centeredY = other.subScalar(other.mean());
        float covariance = centeredX.innerProduct(centeredY) / len;

        return covariance;
    }

    @Override
    public IVector<Float> apply(Function<Float, Float> fun) {
        if (fun == null) {
    ...
    @Override
    public IVector<Float> concat(IVector<Float> other) {
        if (other == null) {
            throw new IllegalArgumentException("输入向量不能为null / Input vector cannot be null");
        }
