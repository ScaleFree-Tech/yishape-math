...
public interface IMatrixDecomposition<T>  {
    ...
    /**
     * Get LAPACK-style error estimates for the most recent decomposition.
     * Computed lazily on first call. Default returns
     * {@link DecompositionErrorEstimate#NOT_AVAILABLE}.
     *
     * @return error estimate, or {@link DecompositionErrorEstimate#NOT_AVAILABLE}
     * @throws IllegalStateException if decomposition has not been performed
     */
    default DecompositionErrorEstimate getErrorEstimate() {
