...
/**
 * Tridiagonal decomposition interface with enhanced features.
 * <p>
 ...
 * <h3>Key Features</h3>
 * <ul>
 *   <li>Efficient reduction to tridiagonal form using Householder reflections</li>
 ...
 * @since 2.0
 */
public interface ITridiagonalDecomposition extends IMatrixDecomposition<Tuple2<IMatrix<Double>, IMatrix<Double>>> {
    /**
     * Performs tridiagonal decomposition of the given matrix
     *
     * @param matrix the matrix to decompose
     * @return a tuple containing (T, Q) where T is the tridiagonal matrix
    ...
    /**
     * Performs tridiagonal decomposition of the given matrix with configurable epsilon.
     *
     * @param matrix the matrix to decompose
