...
public class TridiagonalDecompositionSolver implements IDecompositionSolver {
    ...
    private IMatrix<Double> solveTridiagonalSystem(IMatrix<Double> b) {
        ...
        // tMatrix from decomposition is read-only here; dense path avoids a full toDoubleArray() alloc
        double[][] tData = DecompositionDenseAccess.rowsForReadOnly(tMatrix);
