...
public class ML {
     ...
     *
     * <p>逻辑回归是一种广泛使用的线性分类算法，通过添加正则化项可以防止过拟合。
     ...
     * @see <a href="https://en.wikipedia.org/wiki/Logistic_regression">Logistic Regression</a>
     */
     ...
     * 创建随机森林分类器。
     *
     * <p>随机森林是一种集成学习方法，通过构建多个决策树并进行投票来提高分类的准确性和稳定性。
     * 它具有以下优点：</p>
     * <ul>
     *   <li>能够处理高维数据</li>
     *   <li>对过拟合有很好的抵抗力</li>
     ...
     * @see <a href="https://en.wikipedia.org/wiki/Random_forest">Random Forest</a>
     */
     ...
     * 创建XGBoost分类器。
     *
     * <p>XGBoost（Extreme Gradient Boosting）是一种高效的梯度提升框架，具有以下特点：</p>
     * <ul>
     *   <li>高预测精度</li>
     *   <li>快速的训练速度</li>
     *   <li>内置的正则化功能</li>
     ...
     *
     * <p>KNN是一种基于实例的学习算法，通过查找训练集中与新样本最相似的k个邻居来进行分类。
     * 算法的工作原理：</p>
     * <ol>
     ...
     *
     * @see RereKnn
     * @see <a href="https://en.wikipedia.org/wiki/K-nearest_neighbors_algorithm">K-Nearest Neighbors</a>
     */
     ...
     * 计算分类器的性能指标。
     *
     * <p>该方法使用真实标签和分类器的预测结果来计算各种分类性能指标，包括：</p>
     * <ul>
     *   <li>准确率（Accuracy）</li>
     *   <li>精确率（Precision）</li>
     *   <li>召回率（Recall）</li>
     ...
     * 执行k折交叉验证来评估分类器的性能。
     *
     * <p>交叉验证是一种评估模型泛化能力的统计方法。k折交叉验证的步骤：</p>
     * <ol>
