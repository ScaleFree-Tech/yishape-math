 ...
 * 分类评估指标工具类
 * <p>
 * 提供类似sk-learn的分类器评估功能，包括准确率、精确率、召回率、F1分数、AUC等指标的计算。
 * 支持二分类和多分类场景，提供全面的性能评估。
 * </p>
 * 
 * @author yishape
 * @version 1.0
...
public class ClassificationMetrics {
    ...
    /**
     * 计算分类评估指标 (带概率)
     * Compute classification evaluation metrics (with probabilities)
     * 
     * @param yTrue 真实标签 / True labels
     * @param yPred 预测标签 / Predicted labels
    ...
    /**
     * 获取混淆矩阵字符串表示
     * Get confusion matrix string representation
     * 
     * @return 混淆矩阵字符串
     */
