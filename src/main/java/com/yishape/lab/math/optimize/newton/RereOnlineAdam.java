...
public class RereOnlineAdam implements IOnlineOptimizer {
     ...
     * @return 每个元素的平方根组成的向量 / Vector of element-wise square roots
     */
     ...
     *
     * @param v1 向量1 / First vector
     * @param v2 向量2 / Second vector
     * @return 每个位置的最大值组成的向量 / Vector of element-wise maximums
     */
