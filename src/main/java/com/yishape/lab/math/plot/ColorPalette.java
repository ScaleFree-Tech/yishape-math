...
public class ColorPalette implements Serializable {
    ...
    // ECharts默认颜色序列（与 JS 版保持一致，供 ECharts 等路径使用）
    ...
    /**
     * JavaFX 画布图表推荐配色：饱和度适中、色相可区分，
     * 适合浅色/深色背景下的报告与仪表盘风格。
     */
    public static final String[] PREMIUM_CHART_COLORS = {
        "#2563eb", "#0891b2", "#0d9488", "#ca8a04", "#9333ea",
        "#db2777", "#4f46e5", "#0ea5e9", "#16a34a", "#ea580c"
    };
    ...
    static {
        ...
        PALETTE_MAP.put("premium", PREMIUM_CHART_COLORS);
