...
public final class Plots {
    ...
    private static volatile PlotProvider provider = PlotProvider.JavaFx;
    private static volatile PlotProvider3d provider3d = PlotProvider3d.EchartsGL; // 默认使用ECharts 3D
...
//    }
    ...
    public static IPlot of(PlotProvider provider) {
        return switch (provider) {
            case PlotProvider.JavaFx ->
                new JavaFxPlot();
            case PlotProvider.Echarts ->
