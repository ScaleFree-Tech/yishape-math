 ...
 * @author lteb2
 */
public class EchartsUniversalStyleApplier implements Serializable {
    ...
    public static void applyToLineSeries(LineSeries series, PlotStyle style) {
        ...
        if (style.getColor() != null) {
            series.setLineStyle(EchartsStyleConverter.toEChartsLineStyle(style));
        }
        ...
        if (style.getAlpha() < 1.0f) {
            series.setAreaStyle(EchartsStyleConverter.toEChartsAreaStyle(style));
        }
    ...
    private static void applyStateStylesToLineSeries(LineSeries series, PlotStyle style) {
        ...
        // 设置高亮时的线条样式
        if (style.getColor() != null) {
            emphasis.setLineStyle(EchartsStyleConverter.toEChartsLineStyle(style));
        }
        
        // 设置高亮时的填充样式
        if (style.getAlpha() < 1.0f) {
            emphasis.setAreaStyle(EchartsStyleConverter.toEChartsAreaStyle(style));
        }
        
        // 设置高亮时的itemStyle
        emphasis.setItemStyle(EchartsStyleConverter.toEChartsItemStyle(style));
    ...
    public static void applyToBarSeries(BarSeries series, PlotStyle style) {
        ...
        // 设置透明度
        if (style.getAlpha() < 1.0f) {
            String colorWithAlpha = EchartsStyleConverter.applyAlpha(style.getColor(), style.getAlpha());
            series.setColor(colorWithAlpha);
        }
        
        // 设置itemStyle（包含边框等详细样式）
        BarItemStyle itemStyle = EchartsStyleConverter.toEChartsBarItemStyle(style);
    ...
    private static void applyStateStylesToBarSeries(BarSeries series, PlotStyle style) {
        ...
        // 设置高亮时的itemStyle
        BarItemStyle emphasisItemStyle = EchartsStyleConverter.toEChartsBarItemStyle(style);
    ...
    public static void applyToPieSeries(PieSeries series, PlotStyle style) {
        ...
        // 设置itemStyle
        PieItemStyle itemStyle = EchartsStyleConverter.toEChartsPieItemStyle(style);
        series.setItemStyle(itemStyle);
    ...
    private static void applyStateStylesToPieSeries(PieSeries series, PlotStyle style) {
        ...
        // 设置高亮时的itemStyle
        PieItemStyle emphasisItemStyle = EchartsStyleConverter.toEChartsPieItemStyle(style);
    ...
    public static void applyToHeatmapSeries(HeatmapSeries series, PlotStyle style) {
        ...
        // 应用特定的热力图样式
        Map<String, Object> heatmapStyleConfig = EchartsStyleConverter.toEChartsHeatmapStyle(style);
        ...
        if (style.getAlpha() < 1.0) {
            // 热力图通过视觉映射控制透明度效果
            series.setItemStyle(EchartsStyleConverter.toEChartsItemStyle(style));
        }
    ...
    private static void applyStateStylesToHeatmapSeries(HeatmapSeries series, PlotStyle style) {
        ...
        // 设置高亮时的itemStyle
        org.icepear.echarts.components.series.ItemStyle emphasisItemStyle = EchartsStyleConverter.toEChartsItemStyle(style);
    ...
    private static void applyStateStylesToRadarSeries(RadarSeries series, PlotStyle style) {
        ...
        // 设置高亮时的线条样式
        org.icepear.echarts.components.series.LineStyle emphasisLineStyle = EchartsStyleConverter.toEChartsLineStyle(style);
        if (style.getColor() != null) {
            String brightColor = brightenColor(style.getColor(), 0.3);
        ...
        // 设置高亮时的填充样式
        if (style.getAlpha() < 1.0) {
            org.icepear.echarts.charts.line.LineAreaStyle emphasisAreaStyle = EchartsStyleConverter.toEChartsAreaStyle(style);
    ...
    public static void applyToBoxplotSeries(BoxplotSeries series, PlotStyle style) {
        ...
        // 设置itemStyle
        org.icepear.echarts.components.series.ItemStyle itemStyle = EchartsStyleConverter.toEChartsItemStyle(style);
        series.setItemStyle(itemStyle);
    ...
    public static void applyToCandlestickSeries(CandlestickSeries series, PlotStyle style) {
        ...
        // 设置itemStyle
        org.icepear.echarts.charts.candlestick.CandlestickItemStyle itemStyle = EchartsStyleConverter.toEChartsCandlestickItemStyle(style);
        series.setItemStyle(itemStyle);
    ...
    private static void applyStateStylesToCandlestickSeries(CandlestickSeries series, PlotStyle style) {
        ...
        // 设置高亮时的itemStyle
        org.icepear.echarts.charts.candlestick.CandlestickItemStyle emphasisItemStyle = EchartsStyleConverter.toEChartsCandlestickItemStyle(style);
