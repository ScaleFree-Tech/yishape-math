...
public class ComplexChartRenderer implements JavaFxChartRenderer {
        ...
        for (int iter = 0; iter < iterMax; iter++) {
            ...
            if (links != null) {
                for (Map<String, Object> L : links) {
                    ...
                    if (si == null || ti == null || si < 0 || ti < 0 || si >= n || ti >= n || si.equals(ti)) {
                        continue;
                    }
    ...
    private void renderParallel(GraphicsContext gc, SeriesData series,
        ...
        Object showGridCfg = themeManager.getCurrentConfig().get("showGrid");
        boolean themeWantsGrid = showGridCfg == null || Boolean.TRUE.equals(showGridCfg);
