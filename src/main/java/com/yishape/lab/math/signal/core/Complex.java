 ...
 * @version 1.0
 * @since 1.0
 * @deprecated Use {@link com.yishape.lab.math.core.Complex} instead. This class is kept for
 *             backward compatibility and delegates to the new implementation internally.
 */
@Deprecated
public class Complex {
    ...
    /** Default epsilon for zero comparisons, ~10 ULPs at 1.0 */
    ...
    public Complex divide(Complex other) {
        ...
        if (denominator < EPSILON) {
            throw new ArithmeticException("除零错误 / Division by near-zero denominator: " + denominator);
        }
