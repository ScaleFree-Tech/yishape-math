...
public class SignalUtilities {
    ...
    public static int[] detectChangePoints(IVector<Double> signal, int windowSize, double threshold) {
        ...
        for (int i = windowSize; i < signal.length() - windowSize; i++) {
            ...
            double frontMean = frontWindow.meanValue();
            double backMean = backWindow.meanValue();
            double frontVar = frontWindow.varValue();
            double backVar = backWindow.varValue();
    ...
    public static IVector<Double> normalize(IVector<Double> signal, double min, double max) {
        ...
        double signalMin = signal.minValue();
        double signalMax = signal.maxValue();
        ...
        return signal.subScalar(signalMin).multiplyByScalar(scale).addScalar(min);
    }
    ...
    public static IVector<Double> detrend(IVector<Double> signal) {
        ...
        double xMean = x.meanValue();
        double yMean = signal.meanValue();
