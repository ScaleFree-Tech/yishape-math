 ...
 * <p>
 * 提供时间序列预测功能，包括ARIMA模型、指数平滑、线性回归预测等。 使用项目现有的stats包和linalg包功能进行预测建模。
 * </p>
 * <p>
 * Provides time series forecasting functionality including ARIMA models,
 * exponential smoothing, linear regression forecasting, etc. Uses existing
 * stats and linalg package functionality for forecasting modeling.
 * </p>
 *
 * @author lteb2
 * @version 1.0
...
public class TimeSeriesForecasting {
     ...
     * <p>
     * 使用简单移动平均方法进行时间序列预测。 Use simple moving average method for time series
     * forecasting.
     * </p>
     *
     ...
     * <p>
     * 使用指数平滑方法进行时间序列预测。 Use exponential smoothing method for time series
     * forecasting.
     * </p>
     *
     * @param timeSeries 输入时间序列 / Input time series
     ...
     * <p>
     * 使用线性回归方法进行时间序列预测。 Use linear regression method for time series
     * forecasting.
     * </p>
     *
     * @param timeSeries 输入时间序列 / Input time series
     ...
     * <p>
     * 使用统一ARIMA模型进行时间序列预测。 Use unified ARIMA model for time series forecasting.
     * </p>
     *
     * @param timeSeries 输入时间序列 / Input time series
     * @param variableIndex 变量索引 / Variable index
     ...
     * <p>
     * 考虑季节性因素的时间序列预测。 Time series forecasting considering seasonal factors.
     * </p>
     *
     * @param timeSeries 输入时间序列 / Input time series
     * @param variableIndex 变量索引 / Variable index
     ...
     * <p>
     * 使用Holt-Winters三参数指数平滑进行预测。 Use Holt-Winters triple exponential smoothing
     * for forecasting.
     * </p>
     *
     * @param timeSeries 输入时间序列 / Input time series
     ...
     * <p>
     * 使用GARCH模型进行波动率预测。 Use GARCH model for volatility forecasting.
     * </p>
     *
     * @param timeSeries 输入时间序列 / Input time series
     * @param variableIndex 变量索引 / Variable index
     ...
     * <p>
     * 使用状态空间模型进行预测。 Use state space model for forecasting.
     * </p>
     *
     * @param timeSeries 输入时间序列 / Input time series
     * @param variableIndex 变量索引 / Variable index
     ...
     * <p>
     * 自动选择最优的预测模型进行预测。 Automatically select optimal forecasting model for
     * prediction.
     * </p>
     *
     * @param timeSeries 输入时间序列 / Input time series
