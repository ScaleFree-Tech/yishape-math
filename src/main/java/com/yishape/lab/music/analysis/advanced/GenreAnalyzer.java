...
public class GenreAnalyzer implements IAdvancedAnalyzer {
     ...
     * <p>
     * 初始化风格分析器，创建节拍分析器和调性分析器实例。
     * Initializes the genre analyzer, creating beat analyzer and key analyzer instances.
     * </p>
     */
    ...
    /**
     * 分析音频数据获取风格结果 / Analyze audio data to get genre result
     * <p>
     * 使用默认参数分析音频数据的音乐风格。
     * Analyzes audio data for music genre using default parameters.
     * </p>
     *
    ...
    /**
     * 分析音频数据获取风格特征 / Analyze audio data to get genre features
     * <p>
     * 使用指定参数分析音频数据的音乐风格和特征。
     * Analyzes audio data for music genre and features using specified parameters.
     * </p>
     *
     * @param audioData 音频数据 / Audio data
     * @param parameters 分析参数 / Analysis parameters
     * @return 风格分析结果映射 / Genre analysis result map
     * @throws AudioProcessingException 处理异常 / Processing exception
     */
    @Override
