...
/**
 * Test to verify that spectrogram file size issue is fixed with more aggressive downsampling
 */
public class SpectrogramSizeTest2 {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            System.out.println("Generating spectrogram plot with aggressive size limitation...");
