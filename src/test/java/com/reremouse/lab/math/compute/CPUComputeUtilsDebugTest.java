...
import com.reremouse.lab.math.linalg.IFloatMatrix;
...
public class CPUComputeUtilsDebugTest {
    ...
    public static void main(String[] args) {
        ...
        IFloatMatrix matrix = new RereFloatMatrix(data);
        ...
        Tuple3<IMatrix<Float>, IVector<Float>, IMatrix<Float>> result = CPUComputeFloatUtils.svd(matrix);
        IMatrix<Float> U = result._1;
        IVector<Float> singularValues = result._2;
        IMatrix<Float> VT = result._3;
        
        System.out.println("\nU维度: " + U.rows() + "x" + U.cols());
        System.out.println("奇异值数量: " + singularValues.length());
        System.out.println("V^T维度: " + VT.rows() + "x" + VT.cols());
