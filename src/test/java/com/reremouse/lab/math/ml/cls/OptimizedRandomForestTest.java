...
import com.reremouse.lab.math.ml.cls.tree.RandomForestHyperparameterOptimizer;
...
public class OptimizedRandomForestTest {
    ...
    public void testEnsembleClassifierVoting() {
        ...
        assertEquals(testFeatures.rows(), result.probabilities.rows());
    ...
    public void testEnsembleClassifierWeightedVoting() {
        ...
        assertEquals(3, ensemble.getClassifierWeights().size());
