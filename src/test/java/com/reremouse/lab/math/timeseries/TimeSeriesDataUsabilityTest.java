...
public class TimeSeriesDataUsabilityTest {
    ...
    public static void main(String[] args) {
        ...
        // 2. 使用构建器模式创建时间序列 / Create time series using builder pattern
        System.out.println("\n2. 使用构建器模式创建时间序列:");
        TimeSeriesData ts2 = TimeSeriesData.builder()
            .data(Linalg.randn(50), "random_data")
            .samplingRate(10.0)
            .build();
        System.out.println("使用构建器创建的时间序列: " + ts2);
