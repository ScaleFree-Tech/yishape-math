...
public class test_q1_q3 {
    public static void main(String[] args) {
        // 测试Float向量
        System.out.println("测试RereFloatVector的q1()和q3()方法:");
        float[] floatData = {1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f, 8.0f, 9.0f, 10.0f};
        RereFloatVector floatVector = new RereFloatVector(floatData);
        
        try {
            Float q1 = floatVector.q1();
            Float q3 = floatVector.q3();
        ...
        RereDoubleVector doubleVector = new RereDoubleVector(doubleData);
        ...
        System.out.println("\n测试空向量:");
        try {
            RereFloatVector emptyFloatVector = new RereFloatVector(new float[0]);
            emptyFloatVector.q1();
        } catch (Exception e) {
        ...
        try {
            RereDoubleVector emptyDoubleVector = new RereDoubleVector(new double[0]);
