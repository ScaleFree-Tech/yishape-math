...
public class PlotDemo {
    ...
    public static void main(String[] args) {
        ...
        double[] y2Data = {1.5f, 2.8f, 4.2f, 5.9f, 7.1f, 8.8f, 10.5f, 12.2f, 13.9f, 15.6f};
        
        IDoubleVector x = new RereDoubleVector(xData);
        IDoubleVector y = new RereDoubleVector(yData);
        IDoubleVector y2 = new RereDoubleVector(y2Data);
        ...
        IDoubleVector pieVector = IDoubleVector.of(pieData);
        plot5.pie(pieVector);
        ...
        IDoubleVector histVector = IDoubleVector.of(histData);
        ...
        xTicks.setTickValues(IDoubleVector.of(new double[]{1, 3, 5, 7, 9}));
        xTicks.setTickLabels(Arrays.asList("周一", "周三", "周五", "周日", "周二"));
        plot9.setXticks(xTicks);
        
        AxisTicks yTicks = new AxisTicks();
        yTicks.setTickValues(IDoubleVector.of(new double[]{0, 5, 10, 15, 20, 25}));
