...
public class RerePlotDemo {
    ...
    public static void main(String[] args) {
        ...
        double[] yData = {20.1f, 3.9f, 16.1f, 8.0f, 20.2f, 12.1f, 14.0f, 6.1f, 18.0f, 2.1f};
        double[] y2Data = {11.5f, 22.8f, 4.2f, 15.9f, 7.1f, 8.8f, 10.5f, 2.2f, 3.9f, 5.6f};
        ...
        xTicks.setTickValues(new RereDoubleVector(new double[]{1, 3, 5, 7, 9}));
        xTicks.setTickLabels(Arrays.asList("周一", "周三", "周五", "周日", "周二"));
        plot9.setXticks(xTicks);
        
        AxisTicks yTicks = new AxisTicks();
        yTicks.setTickValues(new RereDoubleVector(new double[]{0, 5, 10, 15, 20, 25}));
