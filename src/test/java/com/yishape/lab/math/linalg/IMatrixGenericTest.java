...
public class IMatrixGenericTest {
    ...
    public void testGenericFactoryMethods() {
        ...
        assertEquals(1.0f, onesFloat.get(0, 0));
        assertEquals(1.0f, onesFloat.get(1, 2));
        ...
        assertEquals(0.0f, zerosFloat.get(0, 0));
        assertEquals(0.0f, zerosFloat.get(2, 1));
        ...
        assertEquals(1.0f, eyeFloat.get(0, 0));
        assertEquals(1.0f, eyeFloat.get(1, 1));
        assertEquals(1.0f, eyeFloat.get(2, 2));
        assertEquals(0.0f, eyeFloat.get(0, 1));
        assertEquals(0.0f, eyeFloat.get(1, 0));
    ...
    public void testInheritedGenericMethods() {
        ...
        IMatrix<Double> transposed = floatMatrix.transpose();
    ...
    public void testBasicMatrixOperations() {
        ...
        IMatrix<Double> scaled = floatMatrix.multiplyByScalar(2.0);
    ...
    public void testStatisticalOperations() {
        // Test sum operation
        Double sum = floatMatrix.sumValue();
        assertEquals(Double.valueOf(21.0), sum); // 1+2+3+4+5+6 = 21
        
        // Test mean operation
        Double mean = floatMatrix.meanValue();
