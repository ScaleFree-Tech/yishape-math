...
public class MatrixNormsAndSolveTest {
    ...
    void testFrobeniusNorm() {
        ...
        double frobeniusNorm = testMatrix.frobeniusNorm();
    ...
    void testEntrywiseL1Norm() {
        ...
        double l1Norm = testMatrix.norm1();
    ...
    void testInducedL1Norm() {
        ...
        double l1Norm = testMatrix.normL1();
    ...
    void testInfinityNorm() {
        ...
        double infNorm = testMatrix.normInf();
    ...
    void testL2Norm() {
        ...
        double l2Norm = testMatrix.norm2();
    ...
    void testBidiagonalMatrix() {
        ...
        assertEquals(1.0, bidiagonal.get(0, 0), 1e-10, "Diagonal element (0,0) should be 1.0");
        assertEquals(2.0, bidiagonal.get(1, 1), 1e-10, "Diagonal element (1,1) should be 2.0");
        assertEquals(3.0, bidiagonal.get(2, 2), 1e-10, "Diagonal element (2,2) should be 3.0");
        
        // Check superdiagonal elements
        assertEquals(4.0, bidiagonal.get(0, 1), 1e-10, "Superdiagonal element (0,1) should be 4.0");
        assertEquals(5.0, bidiagonal.get(1, 2), 1e-10, "Superdiagonal element (1,2) should be 5.0");
        
        // Check that other elements are zero
        assertEquals(0.0, bidiagonal.get(1, 0), 1e-10, "Element (1,0) should be 0.0");
        assertEquals(0.0, bidiagonal.get(2, 0), 1e-10, "Element (2,0) should be 0.0");
        assertEquals(0.0, bidiagonal.get(2, 1), 1e-10, "Element (2,1) should be 0.0");
    ...
    void testTridiagonalMatrix() {
        ...
        // Check diagonal elements
        assertEquals(3.0, tridiagonal.get(0, 0), 1e-10, "Diagonal element (0,0) should be 3.0");
        assertEquals(4.0, tridiagonal.get(1, 1), 1e-10, "Diagonal element (1,1) should be 4.0");
        assertEquals(5.0, tridiagonal.get(2, 2), 1e-10, "Diagonal element (2,2) should be 5.0");
        
        // Check subdiagonal elements
        assertEquals(1.0, tridiagonal.get(1, 0), 1e-10, "Subdiagonal element (1,0) should be 1.0");
        assertEquals(2.0, tridiagonal.get(2, 1), 1e-10, "Subdiagonal element (2,1) should be 2.0");
        
        // Check superdiagonal elements
        assertEquals(6.0, tridiagonal.get(0, 1), 1e-10, "Superdiagonal element (0,1) should be 6.0");
        assertEquals(7.0, tridiagonal.get(1, 2), 1e-10, "Superdiagonal element (1,2) should be 7.0");
        
        // Check that other elements are zero
        assertEquals(0.0, tridiagonal.get(0, 2), 1e-10, "Element (0,2) should be 0.0");
        assertEquals(0.0, tridiagonal.get(2, 0), 1e-10, "Element (2,0) should be 0.0");
