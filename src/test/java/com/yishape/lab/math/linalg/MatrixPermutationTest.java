...
public class MatrixPermutationTest {
    ...
    void testPermuteRows() {
        ...
        assertEquals(7.0, permutedMatrix.get(0, 0), 1e-10);
        assertEquals(8.0, permutedMatrix.get(0, 1), 1e-10);
        assertEquals(9.0, permutedMatrix.get(0, 2), 1e-10);
        
        assertEquals(1.0, permutedMatrix.get(1, 0), 1e-10);
        assertEquals(2.0, permutedMatrix.get(1, 1), 1e-10);
        assertEquals(3.0, permutedMatrix.get(1, 2), 1e-10);
        
        assertEquals(4.0, permutedMatrix.get(2, 0), 1e-10);
        assertEquals(5.0, permutedMatrix.get(2, 1), 1e-10);
        assertEquals(6.0, permutedMatrix.get(2, 2), 1e-10);
    ...
    void testPermuteColumns() {
        ...
        assertEquals(3.0, permutedMatrix.get(0, 0), 1e-10);
        assertEquals(1.0, permutedMatrix.get(0, 1), 1e-10);
        assertEquals(2.0, permutedMatrix.get(0, 2), 1e-10);
        
        assertEquals(6.0, permutedMatrix.get(1, 0), 1e-10);
        assertEquals(4.0, permutedMatrix.get(1, 1), 1e-10);
        assertEquals(5.0, permutedMatrix.get(1, 2), 1e-10);
        
        assertEquals(9.0, permutedMatrix.get(2, 0), 1e-10);
        assertEquals(7.0, permutedMatrix.get(2, 1), 1e-10);
        assertEquals(8.0, permutedMatrix.get(2, 2), 1e-10);
    ...
    void testLinalgPermuteMethods() {
        ...
        // Check that the rows have been permuted correctly
        assertEquals(4.0, permutedRows.get(0, 0), 1e-10);
        assertEquals(7.0, permutedRows.get(1, 0), 1e-10);
        assertEquals(1.0, permutedRows.get(2, 0), 1e-10);
        ...
        // Check that the columns have been permuted correctly
        assertEquals(2.0, permutedCols.get(0, 0), 1e-10);
        assertEquals(3.0, permutedCols.get(0, 1), 1e-10);
        assertEquals(1.0, permutedCols.get(0, 2), 1e-10);
