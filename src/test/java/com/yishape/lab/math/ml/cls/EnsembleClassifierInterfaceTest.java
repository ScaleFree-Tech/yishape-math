...
public class EnsembleClassifierInterfaceTest {
    ...
    public void testIClassificationInterface() {
        ...
        ClassificationResult result = classifier.fit(features, labels);
        assertNotNull(result, "fit方法应该返回非空的ClassificationResult");
        assertTrue(result instanceof EnsembleResult,
                  "返回结果应该是EnsembleClassificationResult类型");
