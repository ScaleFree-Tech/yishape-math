...
public class DecisionTreeLinearSvmTest {
    ...
    void mlFactoriesConstructModels() {
        assertTrue(ML.clf.decisionTree() instanceof RereDecisionTree);
        assertTrue(ML.clf.linearSvm() instanceof RereLinearSVM);
        assertTrue(ML.clf.decisionTree(DecisionTreeCriterion.C45_GAIN_RATIO, 4, 2, 1) instanceof RereDecisionTree);
    }
