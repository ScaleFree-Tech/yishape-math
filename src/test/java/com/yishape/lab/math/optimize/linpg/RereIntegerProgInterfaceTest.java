...
public class RereIntegerProgInterfaceTest {
    ...
    public void testSetAllVariablesInteger() {
        ...
        OptResult result2 = solver.solveWithNonNegativeEqualConstraints(c2, A_eq2, b_eq2);
    ...
    public void testSetAllVariablesBinary() {
        ...
        OptResult result2 = solver.solve(c2, A_ub2, b_ub2);
    ...
    /**
     * Test that setAllVariablesInteger() does not throw exception when called before solving
     */
    @Test
    public void testSetAllVariablesIntegerBeforeSolving() {
        ...
        solver.setAllVariablesInteger(); // Should not throw IllegalStateException
        
        // Verify that the flag is set
        // This is a bit tricky to test directly since the fields are private
        // We'll test by solving a problem and checking that all variables are integer
    ...
    /**
     * Test that setAllVariablesBinary() does not throw exception when called before solving
     */
    @Test
    public void testSetAllVariablesBinaryBeforeSolving() {
        ...
        // Should not throw any exception
        solver.setAllVariablesBinary(); // Should not throw IllegalStateException
        
        // Verify that the flag is set by solving a problem
        IVector c = Linalg.vector(new double[]{-1, -2}); // Maximize x1 + 2*x2
        IMatrix A_ub = Linalg.matrix(new double[][]{{1, 1}});
        IVector b_ub = Linalg.vector(new double[]{1}); // x1 + x2 <= 1
