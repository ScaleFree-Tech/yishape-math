...
/**
 * Simple test to verify that the integer programming solver is working correctly for a small knapsack problem
 */
public class SimpleKnapsackTest {
    public static void main(String[] args) {
        ...
        System.out.println("Solving simple knapsack problem:");
