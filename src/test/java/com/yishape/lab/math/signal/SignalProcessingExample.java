...
public class SignalProcessingExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("  均值: " + filteredMA.meanValue());
        System.out.println("  标准差: " + filteredMA.stdValue());
        
        // 高斯滤波 / Gaussian filter
        IVector<Double> filteredGaussian = Signals.gaussianFilter(signal, 2.0, 0);
        System.out.println("高斯滤波后:");
        System.out.println("  均值: " + filteredGaussian.meanValue());
        System.out.println("  标准差: " + filteredGaussian.stdValue());
        ...
        System.out.println("  均值: " + filteredLP.meanValue());
        System.out.println("  标准差: " + filteredLP.stdValue());
        ...
        System.out.println("  最大值: " + autocorr.maxValue());
        ...
        System.out.println("  包络均值: " + envelope.meanValue());
        System.out.println("  相位范围: " + phase.minValue() + " - " + phase.maxValue() + " rad");
        ...
        System.out.println("  最大幅度: " + Linalg.vector(magnitude).maxValue());
        ...
        System.out.println("  汉宁窗最大值: " + hanningWindow.maxValue());
        System.out.println("  汉明窗最大值: " + hammingWindow.maxValue());
