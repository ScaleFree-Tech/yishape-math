...
public class WaveletAnalysisExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("  原始信号均值: " + signal.mean());
        System.out.println("  去趋势后均值: " + detrended.mean());
        
        System.out.println("平滑结果:");
        System.out.println("  原始信号标准差: " + signal.std());
        System.out.println("  平滑后标准差: " + smoothed.std());
