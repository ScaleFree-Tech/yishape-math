...
public class IPlotDemo {
    ...
    public static void main(String[] args) {
        ...
        IFloatVector x = IFloatVector.of(xData);
        IFloatVector y = IFloatVector.of(yData);
        IFloatVector y2 = IFloatVector.of(y2Data);
        ...
        IFloatVector pieVector = IFloatVector.of(pieData);
        plot5.pie(pieVector);
        ...
        IFloatVector histVector = IFloatVector.of(histData);
        ...
        xTicks.setTickValues(IFloatVector.of(new float[]{1, 3, 5, 7, 9}));
        xTicks.setTickLabels(Arrays.asList("周一", "周三", "周五", "周日", "周二"));
        plot9.setXticks(xTicks);
        
        AxisTicks yTicks = new AxisTicks();
        yTicks.setTickValues(IFloatVector.of(new float[]{0, 5, 10, 15, 20, 25}));
