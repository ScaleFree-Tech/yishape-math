...
public class LinearRegressionDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            linearRegression.fit(featureMatrix, labelVector);
            RegressionResult result = linearRegression.getResult();
        ...
        try {
            ...
            lrL1.fit(featureMatrix, labelVector);
            RegressionResult resultL1 = lrL1.getResult();
        ...
        try {
            ...
            lrL2.fit(featureMatrix, labelVector);
            RegressionResult resultL2 = lrL2.getResult();
        ...
        try {
            ...
            lrElasticNet.fit(featureMatrix, labelVector);
            RegressionResult resultElasticNet = lrElasticNet.getResult();
        ...
        try {
            ...
            // 训练模型
            lrDynamic.fit(featureMatrix, labelVector);
            RegressionResult resultDynamic = lrDynamic.getResult();
